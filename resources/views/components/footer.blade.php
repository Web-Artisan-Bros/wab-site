<div class="container py-5 wab-footer">
    <div class="py-md-5">
        <div class="row py-md-5">
            <div class="col">
                ...
                <div class="d-flex flex-column align-items-start">
                    ...
                    <div class="flex-fill">
                        ...
                        <div>
                            <a href="#" class="me-5 text-light"><small>Privacy Policy</small></a>
                            <a href="#" class="text-light"><small>Cookie Policy</small></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="mb-5">
                    <div class="d-flex align-items-end justify-content-between  border-bottom border-3 border-primary  div-with-title">

                        <img class="me-2" src="/assets/Logo.svg" style="max-width: 170px; max-height: 113px;" alt="logo">

                        <p class="fs-3  mt-auto"><span class="text-primary">W</span>eb <span class="text-primary">A</span>rtisan <span class="text-primary">B</span>ros</p>
