...
<div>
  ...
  <nav class="navbar navbar-expand-lg py-3 wab-nav">
    <div class="container">
      ...
      <button class="navbar-toggler" type="button"
              ...
              data-bs-target="#wab-navbar-menu"
              aria-controls="wab-navbar-menu"
              aria-expanded="false"
      ...
      <div class="collapse navbar-collapse" id="wab-navbar-menu">
        ...
        <button class=" btn btn-primary ms-1" type="button" data-bs-toggle="offcanvas" href="#offcanvasExample"
  ...
  <div class="offcanvas offcanvas-end  wbaOffCanvas px-2" tabindex="-1" id="offcanvasExample"
    ...
    <div class="offcanvas-body">
      ...
      <div class="border border-3 border-dark p-3 mb-5 offcanvas-form">
        ...
        <div class="form-floating mb-3">
          ...
          <label for="exampleFormControlTextarea1" class="form-label">Inserisci il tuo messaggio:<span
