          ...
          <form class="">
            <fieldset>
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="{{ __('Il tuo nome')}}">
              ...
              <div class="form-floating mb-3">
                <input type="tel" class="form-control" id="floatingInput" placeholder="{{ __('Il tuo telefono')}}">
                <label for="floatingInput" class="form-label">{{ __('Telefono')}}</label>
              </div>

              <div class="form-floating mb-3">
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="{{ __('Il tuo messaggio')}}"
                        contenteditable></textarea>
                <label for="exampleFormControlTextarea1" class="form-label">
                  <span class="accent-color">*</span>
                  {{ __('Inserisci il tuo messaggio')}}
                </label>
              </div>
            </fieldset>

            <p class="accent-color mb-5 ms-3">* {{ __('campo obbligatorio')}}</p>
