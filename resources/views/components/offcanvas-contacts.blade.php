  ...
  <div class="offcanvas-body">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="lead pb-5">
            Qualsiasi cosa per <span class="wab-highlight">aiutarti</span> a definire la tua presenza online, trasformiamo le tue idee e le tue <span class="wab-highlight">necessità</span>
            in un
            prodotto concreto!
          </div>
